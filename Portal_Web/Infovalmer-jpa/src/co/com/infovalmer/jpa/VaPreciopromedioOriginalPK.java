...
/**
 * The primary key class for the va_preciopromedio_original database table.
 * 
 */
@Embeddable
public class VaPreciopromedioOriginalPK implements Serializable {
	...
	public VaPreciopromedioOriginalPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VaPreciopromedioOriginalPK)) {
			return false;
		}
		VaPreciopromedioOriginalPK castOther = (VaPreciopromedioOriginalPK)other;
		return 
