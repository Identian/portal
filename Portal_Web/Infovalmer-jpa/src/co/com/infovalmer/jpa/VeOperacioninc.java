...
/**
 * The persistent class for the ve_operacioninc database table.
 * 
 */
@Entity
@Table(name="ve_operacioninc")
@NamedQuery(name="VeOperacioninc.findAll", query="SELECT v FROM VeOperacioninc v")
public class VeOperacioninc implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private VeOperacionincPK id;
	...
	public VeOperacioninc() {
	}

	public VeOperacionincPK getId() {
		return this.id;
	}

	public void setId(VeOperacionincPK id) {
		this.id = id;
	}
