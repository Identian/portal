...
/**
 * The persistent class for the ve_operacionesporincluir database table.
 * 
 */
@Entity
@Table(name="ve_operacionesporincluir")
@NamedQuery(name="VeOperacionesporincluir.findAll", query="SELECT v FROM VeOperacionesporincluir v")
public class VeOperacionesporincluir implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private VeOperacionesporincluirPK id;
	...
	public VeOperacionesporincluir() {
	}

	public VeOperacionesporincluirPK getId() {
		return this.id;
	}

	public void setId(VeOperacionesporincluirPK id) {
		this.id = id;
	}
