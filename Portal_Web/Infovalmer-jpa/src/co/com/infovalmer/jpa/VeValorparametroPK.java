...
/**
 * The primary key class for the ve_valorparametro database table.
 * 
 */
@Embeddable
public class VeValorparametroPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VeValorparametroPK)) {
			return false;
		}
		VeValorparametroPK castOther = (VeValorparametroPK)other;
		return 
