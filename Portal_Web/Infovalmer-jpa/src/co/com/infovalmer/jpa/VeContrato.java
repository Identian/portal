...
/**
 * The persistent class for the ve_contratos database table.
 * 
 */
@Entity
@Table(name = "ve_contratos")
@NamedQueries({
		@NamedQuery(name = "VeContrato.findAll", query = "SELECT v FROM VeContrato v"),
		@NamedQuery(name = "VeContrato.findContratoNemoSubyacente", query = "SELECT v FROM VeContrato v WHERE v.cNemosubyacente = ?1") })
public class VeContrato implements Serializable {
