...
/**
 * The persistent class for the po_noticias database table.
 * 
 */
@Entity
@Table(name="po_noticias")
@NamedQuery(name="PoNoticia.findAll", query="SELECT p FROM PoNoticia p")
public class PoNoticia implements Serializable {
