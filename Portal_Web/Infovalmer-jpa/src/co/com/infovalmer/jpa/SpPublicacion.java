...
/**
 * The persistent class for the sp_publicacion database table.
 * 
 */
@Entity
@Table(name="sp_publicacion")
@NamedQuery(name="SpPublicacion.findAll", query="SELECT s FROM SpPublicacion s")
public class SpPublicacion implements Serializable {
