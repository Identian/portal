...
/**
 * The primary key class for the vd_logcasoespecial database table.
 * 
 */
@Embeddable
public class VdLogcasoespecialPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdLogcasoespecialPK)) {
			return false;
		}
		VdLogcasoespecialPK castOther = (VdLogcasoespecialPK)other;
		return 
