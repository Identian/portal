...
/**
 * The primary key class for the vd_ponderadorindice database table.
 * 
 */
@Embeddable
public class VdPonderadorindicePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdPonderadorindicePK)) {
			return false;
		}
		VdPonderadorindicePK castOther = (VdPonderadorindicePK)other;
		return 
