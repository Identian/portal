...
/**
 * The primary key class for the vd_puntosfwd database table.
 * 
 */
@Embeddable
public class VdPuntosfwdPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdPuntosfwdPK)) {
			return false;
		}
		VdPuntosfwdPK castOther = (VdPuntosfwdPK)other;
		return 
