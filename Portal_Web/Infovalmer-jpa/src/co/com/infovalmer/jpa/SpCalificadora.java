 ...
 */
@Entity
@Table(name="sp_calificadora")
@NamedQuery(name="SpCalificadora.findAll", query="SELECT s FROM SpCalificadora s")
public class SpCalificadora implements Serializable {
