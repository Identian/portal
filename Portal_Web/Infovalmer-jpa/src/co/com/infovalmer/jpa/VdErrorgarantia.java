...
/**
 * The persistent class for the vd_errorgarantia database table.
 * 
 */
@Entity
@Table(name="vd_errorgarantia")
@NamedQuery(name="VdErrorgarantia.findAll", query="SELECT v FROM VdErrorgarantia v")
public class VdErrorgarantia implements Serializable {
