...
/**
 * The primary key class for the ve_logoperinc database table.
 * 
 */
@Embeddable
public class VeLogoperincPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VeLogoperincPK)) {
			return false;
		}
		VeLogoperincPK castOther = (VeLogoperincPK)other;
		return 
