...
/**
 * The primary key class for the ve_log_operaciones database table.
 * 
 */
@Embeddable
public class VeLogOperacionePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VeLogOperacionePK)) {
			return false;
		}
		VeLogOperacionePK castOther = (VeLogOperacionePK)other;
		return 
