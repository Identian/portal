...
/**
 * The primary key class for the vd_preciosvaloracion_original database table.
 * 
 */
@Embeddable
public class VdPreciosvaloracionOriginalPK implements Serializable {
	...
	public VdPreciosvaloracionOriginalPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdPreciosvaloracionOriginalPK)) {
			return false;
		}
		VdPreciosvaloracionOriginalPK castOther = (VdPreciosvaloracionOriginalPK)other;
		return 
