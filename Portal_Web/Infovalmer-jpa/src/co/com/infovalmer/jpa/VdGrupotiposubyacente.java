...
/**
 * The persistent class for the vd_grupotiposubyacente database table.
 * 
 */
@Entity
@Table(name="vd_grupotiposubyacente")
@NamedQuery(name="VdGrupotiposubyacente.findAll", query="SELECT v FROM VdGrupotiposubyacente v")
public class VdGrupotiposubyacente implements Serializable {
