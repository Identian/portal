...
/**
 * The primary key class for the vd_log_operaciones database table.
 * 
 */
@Embeddable
public class VdLogOperacionePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdLogOperacionePK)) {
			return false;
		}
		VdLogOperacionePK castOther = (VdLogOperacionePK)other;
		return 
