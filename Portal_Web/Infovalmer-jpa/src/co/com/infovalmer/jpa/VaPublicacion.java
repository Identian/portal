...
/**
 * The persistent class for the va_publicacion database table.
 * 
 */
@Entity
@Table(name="va_publicacion")
@NamedQuery(name="VaPublicacion.findAll", query="SELECT v FROM VaPublicacion v")
public class VaPublicacion implements Serializable {
