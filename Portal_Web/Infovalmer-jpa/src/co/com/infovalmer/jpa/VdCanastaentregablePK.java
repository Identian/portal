...
/**
 * The primary key class for the vd_canastaentregables database table.
 * 
 */
@Embeddable
public class VdCanastaentregablePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdCanastaentregablePK)) {
			return false;
		}
		VdCanastaentregablePK castOther = (VdCanastaentregablePK)other;
		return 
