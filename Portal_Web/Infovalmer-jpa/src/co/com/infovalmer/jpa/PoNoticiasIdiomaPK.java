...
/**
 * The primary key class for the po_noticias_idioma database table.
 * 
 */
@Embeddable
public class PoNoticiasIdiomaPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PoNoticiasIdiomaPK)) {
			return false;
		}
		PoNoticiasIdiomaPK castOther = (PoNoticiasIdiomaPK)other;
		return 
