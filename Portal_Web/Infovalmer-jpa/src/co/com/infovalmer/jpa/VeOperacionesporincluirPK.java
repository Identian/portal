...
/**
 * The primary key class for the ve_operacionesporincluir database table.
 * 
 */
@Embeddable
public class VeOperacionesporincluirPK implements Serializable {
	...
	public VeOperacionesporincluirPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VeOperacionesporincluirPK)) {
			return false;
		}
		VeOperacionesporincluirPK castOther = (VeOperacionesporincluirPK)other;
		return 
