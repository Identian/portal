...
/**
 * The primary key class for the ve_pagodividendos database table.
 * 
 */
@Embeddable
public class VePagodividendoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VePagodividendoPK)) {
			return false;
		}
		VePagodividendoPK castOther = (VePagodividendoPK)other;
		return 
