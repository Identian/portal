...
/**
 * The persistent class for the va_operacion database table.
 * 
 */
@Entity
@Table(name="va_operacion")
@NamedQuery(name="VaOperacion.findAll", query="SELECT v FROM VaOperacion v")
public class VaOperacion implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private VaOperacionPK id;
	...
	public VaOperacionPK getId() {
		return this.id;
	}

	public void setId(VaOperacionPK id) {
		this.id = id;
	}
