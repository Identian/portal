...
/**
 * The primary key class for the ve_preciosvaloracion database table.
 * 
 */
@Embeddable
public class VePreciosvaloracionPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VePreciosvaloracionPK)) {
			return false;
		}
		VePreciosvaloracionPK castOther = (VePreciosvaloracionPK)other;
		return 
