...
/**
 * The primary key class for the ve_operaciones database table.
 * 
 */
@Embeddable
public class VeOperacionePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VeOperacionePK)) {
			return false;
		}
		VeOperacionePK castOther = (VeOperacionePK)other;
		return 
