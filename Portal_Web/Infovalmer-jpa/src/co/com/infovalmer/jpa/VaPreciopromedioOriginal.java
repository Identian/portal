...
/**
 * The persistent class for the va_preciopromedio_original database table.
 * 
 */
@Entity
@Table(name="va_preciopromedio_original")
@NamedQuery(name="VaPreciopromedioOriginal.findAll", query="SELECT v FROM VaPreciopromedioOriginal v")
public class VaPreciopromedioOriginal implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private VaPreciopromedioOriginalPK id;
	...
	public VaPreciopromedioOriginal() {
	}

	public VaPreciopromedioOriginalPK getId() {
		return this.id;
	}

	public void setId(VaPreciopromedioOriginalPK id) {
		this.id = id;
	}
