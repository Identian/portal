...
/**
 * The primary key class for the ve_logoperexc database table.
 * 
 */
@Embeddable
public class VeLogoperexcPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VeLogoperexcPK)) {
			return false;
		}
		VeLogoperexcPK castOther = (VeLogoperexcPK)other;
		return 
