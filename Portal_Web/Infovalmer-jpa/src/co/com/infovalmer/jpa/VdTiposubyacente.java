...
/**
 * The persistent class for the vd_tiposubyacente database table.
 * 
 */
@Entity
@Table(name="vd_tiposubyacente")
@NamedQuery(name="VdTiposubyacente.findAll", query="SELECT v FROM VdTiposubyacente v")
public class VdTiposubyacente implements Serializable {
