...
/**
 * The primary key class for the vd_operaciones database table.
 * 
 */
@Embeddable
public class VdOperacionePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdOperacionePK)) {
			return false;
		}
		VdOperacionePK castOther = (VdOperacionePK)other;
		return 
