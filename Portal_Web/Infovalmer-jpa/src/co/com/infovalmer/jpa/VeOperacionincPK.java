...
/**
 * The primary key class for the ve_operacioninc database table.
 * 
 */
@Embeddable
public class VeOperacionincPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VeOperacionincPK)) {
			return false;
		}
		VeOperacionincPK castOther = (VeOperacionincPK)other;
		return 
