...
/**
 * The persistent class for the sp_hcategoria database table.
 * 
 */
@Entity
@Table(name="sp_hcategoria")
@NamedQuery(name="SpHcategoria.findAll", query="SELECT s FROM SpHcategoria s")
public class SpHcategoria implements Serializable {
	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	private SpHcategoriaPK id; 
