...
/**
 * The primary key class for the va_preciovaloracion database table.
 * 
 */
@Embeddable
public class VaPreciovaloracionPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VaPreciovaloracionPK)) {
			return false;
		}
		VaPreciovaloracionPK castOther = (VaPreciovaloracionPK)other;
		return 
