...
/**
 * The primary key class for the ve_factorconv database table.
 * 
 */
@Embeddable
public class VeFactorconvPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VeFactorconvPK)) {
			return false;
		}
		VeFactorconvPK castOther = (VeFactorconvPK)other;
		return 
