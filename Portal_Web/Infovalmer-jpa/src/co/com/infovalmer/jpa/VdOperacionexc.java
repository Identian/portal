...
/**
 * The persistent class for the vd_operacionexc database table.
 * 
 */
@Entity
@Table(name="vd_operacionexc")
@NamedQuery(name="VdOperacionexc.findAll", query="SELECT v FROM VdOperacionexc v")
public class VdOperacionexc implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private VdOperacionexcPK id;
	...
	public VdOperacionexc() {
	}

	public VdOperacionexcPK getId() {
		return this.id;
	}

	public void setId(VdOperacionexcPK id) {
		this.id = id;
	}
