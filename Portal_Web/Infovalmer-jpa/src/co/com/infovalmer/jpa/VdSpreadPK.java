...
/**
 * The primary key class for the vd_spreads database table.
 * 
 */
@Embeddable
public class VdSpreadPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdSpreadPK)) {
			return false;
		}
		VdSpreadPK castOther = (VdSpreadPK)other;
		return 
