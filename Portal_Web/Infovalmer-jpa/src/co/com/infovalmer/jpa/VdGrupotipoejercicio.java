...
/**
 * The persistent class for the vd_grupotipoejercicio database table.
 * 
 */
@Entity
@Table(name="vd_grupotipoejercicio")
@NamedQuery(name="VdGrupotipoejercicio.findAll", query="SELECT v FROM VdGrupotipoejercicio v")
public class VdGrupotipoejercicio implements Serializable {
