...
/**
 * The primary key class for the vd_operacionexc database table.
 * 
 */
@Embeddable
public class VdOperacionexcPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdOperacionexcPK)) {
			return false;
		}
		VdOperacionexcPK castOther = (VdOperacionexcPK)other;
		return 
