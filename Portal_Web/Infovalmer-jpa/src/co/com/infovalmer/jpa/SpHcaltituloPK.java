...
/**
 * The primary key class for the sp_hcaltitulo database table.
 * 
 */
@Embeddable
public class SpHcaltituloPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SpHcaltituloPK)) {
			return false;
		}
		SpHcaltituloPK castOther = (SpHcaltituloPK)other;
		return 
