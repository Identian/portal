...
/**
 * The persistent class for the vd_operaciones database table.
 * 
 */
@Entity
@Table(name="vd_operaciones")
@NamedQuery(name="VdOperacione.findAll", query="SELECT v FROM VdOperacione v")
public class VdOperacione implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private VdOperacionePK id;
	...
	public VdOperacionePK getId() {
		return this.id;
	}

	public void setId(VdOperacionePK id) {
		this.id = id;
	}
