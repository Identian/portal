...
/**
 * The primary key class for the va_muestprecio database table.
 * 
 */
@Embeddable
public class VaMuestprecioPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VaMuestprecioPK)) {
			return false;
		}
		VaMuestprecioPK castOther = (VaMuestprecioPK)other;
		return 
