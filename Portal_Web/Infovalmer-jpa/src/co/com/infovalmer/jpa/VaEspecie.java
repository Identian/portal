...
/**
 * The persistent class for the va_especie database table.
 * 
 */
@Entity
@Table(name="va_especie")
@NamedQuery(name="VaEspecie.findAll", query="SELECT v FROM VaEspecie v")
public class VaEspecie implements Serializable {
