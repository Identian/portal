...
/**
 * The primary key class for the sp_haoperacion database table.
 * 
 */
@Embeddable
public class SpHaoperacionPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SpHaoperacionPK)) {
			return false;
		}
		SpHaoperacionPK castOther = (SpHaoperacionPK)other;
		return 
