...
/**
 * The primary key class for the vd_operacioninc database table.
 * 
 */
@Embeddable
public class VdOperacionincPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdOperacionincPK)) {
			return false;
		}
		VdOperacionincPK castOther = (VdOperacionincPK)other;
		return 
