...
/**
 * The primary key class for the vd_precioslimpios database table.
 * 
 */
@Embeddable
public class VdPrecioslimpioPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdPrecioslimpioPK)) {
			return false;
		}
		VdPrecioslimpioPK castOther = (VdPrecioslimpioPK)other;
		return 
