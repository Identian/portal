...
/**
 * The primary key class for the vd_volatilidad database table.
 * 
 */
@Embeddable
public class VdVolatilidadPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdVolatilidadPK)) {
			return false;
		}
		VdVolatilidadPK castOther = (VdVolatilidadPK)other;
		return 
