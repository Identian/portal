...
/**
 * The persistent class for the va_logespecie database table.
 * 
 */
@Entity
@Table(name="va_logespecie")
@NamedQuery(name="VaLogespecie.findAll", query="SELECT v FROM VaLogespecie v")
public class VaLogespecie implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private VaLogespeciePK id;
	...
	private String eValordividendo;
	...
	public VaLogespeciePK getId() {
		return this.id;
	}

	public void setId(VaLogespeciePK id) {
		this.id = id;
	}
	...
	public String getEValordividendo() {
		return this.eValordividendo;
	}

	public void setEValordividendo(String eValordividendo) {
