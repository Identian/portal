...
/**
 * The persistent class for the po_suscriptor database table.
 * 
 */
@Entity
@Table(name="po_suscriptor")
@NamedQuery(name="PoSuscriptor.findAll", query="SELECT p FROM PoSuscriptor p")
public class PoSuscriptor implements Serializable {
	...
	@Column(name="c_contador")
	private String cContador;
	...
	public String getCContador() {
		return this.cContador;
	}

	public void setCContador(String cContador) {
		this.cContador = cContador;
	}
