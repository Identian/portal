...
/**
 * The primary key class for the vd_logoperexc database table.
 * 
 */
@Embeddable
public class VdLogoperexcPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdLogoperexcPK)) {
			return false;
		}
		VdLogoperexcPK castOther = (VdLogoperexcPK)other;
		return 
