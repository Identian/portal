...
/**
 * The persistent class for the vd_estadisticacrcc database table.
 * 
 */
@Entity
@Table(name="vd_estadisticacrcc")
@NamedQuery(name="VdEstadisticacrcc.findAll", query="SELECT v FROM VdEstadisticacrcc v")
public class VdEstadisticacrcc implements Serializable {
