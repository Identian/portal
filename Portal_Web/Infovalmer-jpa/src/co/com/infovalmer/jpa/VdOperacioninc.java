...
/**
 * The persistent class for the vd_operacioninc database table.
 * 
 */
@Entity
@Table(name="vd_operacioninc")
@NamedQuery(name="VdOperacioninc.findAll", query="SELECT v FROM VdOperacioninc v")
public class VdOperacioninc implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private VdOperacionincPK id;
	...
	public VdOperacioninc() {
	}

	public VdOperacionincPK getId() {
		return this.id;
	}

	public void setId(VdOperacionincPK id) {
		this.id = id;
	}
