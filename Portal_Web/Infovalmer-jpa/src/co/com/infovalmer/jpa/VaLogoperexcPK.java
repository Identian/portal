...
/**
 * The primary key class for the va_logoperexc database table.
 * 
 */
@Embeddable
public class VaLogoperexcPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VaLogoperexcPK)) {
			return false;
		}
		VaLogoperexcPK castOther = (VaLogoperexcPK)other;
		return 
