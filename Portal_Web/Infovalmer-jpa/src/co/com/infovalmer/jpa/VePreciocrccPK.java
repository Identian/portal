...
/**
 * The primary key class for the ve_preciocrcc database table.
 * 
 */
@Embeddable
public class VePreciocrccPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VePreciocrccPK)) {
			return false;
		}
		VePreciocrccPK castOther = (VePreciocrccPK)other;
		return 
