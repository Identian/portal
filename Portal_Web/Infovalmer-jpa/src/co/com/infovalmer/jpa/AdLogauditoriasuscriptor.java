...
/**
 * The persistent class for the ad_logauditoriasuscriptor database table.
 * 
 */
@Entity
@Table(name="ad_logauditoriasuscriptor")
@NamedQuery(name="AdLogauditoriasuscriptor.findAll", query="SELECT a FROM AdLogauditoriasuscriptor a")
public class AdLogauditoriasuscriptor implements Serializable {
	...
	public AdLogauditoriasuscriptor() {
	}
