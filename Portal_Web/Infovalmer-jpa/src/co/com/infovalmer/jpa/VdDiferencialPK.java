...
/**
 * The primary key class for the vd_diferencial database table.
 * 
 */
@Embeddable
public class VdDiferencialPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VdDiferencialPK)) {
			return false;
		}
		VdDiferencialPK castOther = (VdDiferencialPK)other;
		return 
