...
/**
 * The primary key class for the po_ve_volumen_contrato database table.
 * 
 */
@Embeddable
public class PoVeVolumenContratoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PoVeVolumenContratoPK)) {
			return false;
		}
		PoVeVolumenContratoPK castOther = (PoVeVolumenContratoPK)other;
		return 
